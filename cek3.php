...
<div class="collapse navbar-collapse" id="navbarNav">
  ...
  <br>
    ...
    <div class="col-md-6 col-11">
        <div class="panel">
            <h4 style=text-align:left;>3. Apakah Anda mengalami salah satu dari berikut:</h4>
            <ul style="text-align: left;">
                ...
                <li>
                    <h4>Sulit Bernapas</h4>
                </li>
            </ul>
            <button type="button" class="sign-btn" onclick="location.href='hasil2.php';">Ya</button>
            <h4 class="atau">Atau</h4>
            <button type="button" class="log-btn" onclick="location.href='cek4.php';">Tidak</button> <br>
        </div>
    </div>
