...
<div class="collapse navbar-collapse" id="navbarNav">
  ...
  <br>
    ...
    <div class="col-md-6 col-11">
        <div class="panel">
            <h4 style=text-align:left;>6. Apakah Anda memiliki kontak dekat dengan seseorang yang bepergian ke luar Negeri dalam 14 hari terakhir yang menjadi sakit (batuk, demam, bersin, atau sakit tenggorokan)?
</h4>

            <button type="button" class="sign-btn" onclick="location.href='hasil2.php';">Ya</button>
            <h4 class="atau">Atau</h4>
            <button type="button" class="log-btn" onclick="location.href='hasilaman.php';">Tidak</button> <br>
        </div>
    </div>
