<?php
    ...
    if(!isset($_SESSION['nama'])){
        header("location: ../register.php?access_denied");
    }
?>
...
<body>
  ...
  <br>
    ...
    <h3 style=" text-align: center;">Data anda berhasil disimpan!</h3><br><br><br><br><br><br><br><br><br><br><br>
<div class="col-md-6 col-11">
    <div class="panel text-align: center;">
        <img src="d.jpg">
        <hr>
        <p>
        Tetap jaga jarak dan jaga kesehatan<br>
        serta tetap DIRUMAHAJA <br>
        </p>
