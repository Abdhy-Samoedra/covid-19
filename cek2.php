...
<div class="collapse navbar-collapse" id="navbarNav">
  ...
  <br>
    ...
    <div class="col-md-6 col-11">
        <div class="panel">
            <h4 style=text-align:left;>2. Apakah Anda mengalami salah satu dari berikut:</h4>
            <ul style="text-align: left;">
                <li>
                    <h4>Nafas yang pendek saat istirahat</h4>
                </li>
                <li>
                    <h4>Ketidakmampuan untuk berbaring karena kesulitan bernafas</h4>
                </li>
                <li>
                    <h4>Kondisi kesehatan kronis yang anda alami dirasakan lebih berat karena kesulitan bernapas</h4>
                </li>
