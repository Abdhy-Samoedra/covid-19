...
<div class="collapse navbar-collapse" id="navbarNav">
  ...
  <br>
    ...
    <div class="col-md-6 col-11">
        <div class="panel">
            <h4 style=text-align:left;>5. Apakah Anda memberikan perawatan atau melakukan kontak dekat dengan seseorang dengan COVID-19 (kemungkinan atau dikonfirmasi) saat mereka sakit (batuk, demam, bersin, atau sakit tenggorokan)?
</h4>

            <button type="button" class="sign-btn" onclick="location.href='hasil2.php';">Ya</button>
            <h4 class="atau">Atau</h4>
            <button type="button" class="log-btn" onclick="location.href='cek6.php';">Tidak</button> <br>
        </div>
    </div>
