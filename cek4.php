...
<div class="collapse navbar-collapse" id="navbarNav">
  ...
  <br>
    ...
    <div class="col-md-6 col-11">
        <div class="panel">
            <h4 style=text-align:left;>4. Apakah anda pernah muncul gejala sekitar 14 hari setelah travelling ke luar negeri? (China, Italy, Iran, Korea Selatan, Prancis, Spanyol, Jerman, USA) atau ke kota terjangkit (Jakarta, Bali, Solo, Yogyakarta, Pontianak, Manado, Bandung dll)?</h4>

            <button type="button" class="sign-btn" onclick="location.href='hasil2.php';">Ya</button>
            <h4 class="atau">Atau</h4>
            <button type="button" class="log-btn" onclick="location.href='cek5.php';">Tidak</button> <br>
        </div>
    </div>
